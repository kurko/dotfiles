...
2. **Track Progress**
   - If the project uses a `todo.md` file, update it
   - If the project uses an online task system, always ask the user
...
5. **Code Review**
   - Always review code before finalizing
   - Use your judgment as an experienced engineer when addressing feedback; consider both technical and product aspects
...
- debugging: document root cause and prevention after fixing production issues
...
- commands/skills: use explicit subjects ("the user", "the agent") - avoid ambiguous "you"
